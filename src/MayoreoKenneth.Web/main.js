...
const ASISTENTE_PASOS = [
  {
    texto:
      "¡Pura vida! Soy el asistente automático de MayoreoKenneth. Le voy llenando el formulario del carrito paso a paso. No sustituyo a una persona ni resuelvo reclamos."
  },
